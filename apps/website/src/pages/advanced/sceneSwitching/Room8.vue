...
const EXITS: Exits = { north: "room5", west: "room7", east: "room9" };
...
<template>
  <Scene name="room8">
    ...
    <template #overlay>
      <RoomNav>
        <template #north><NavButton to="room5">↑</NavButton></template>
        <template #west><NavButton to="room7">←</NavButton></template>
        <template #east><NavButton to="room9">→</NavButton></template>
        <template #center>VIII</template>
      </RoomNav>
    </template>
  </Scene>
</template>
