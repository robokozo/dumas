...
const EXITS: Exits = { west: "room1", east: "room3", south: "room5" };
...
<template>
  <Scene name="room2">
    ...
    <template #overlay>
      <RoomNav>
        <template #west><NavButton to="room1">←</NavButton></template>
        <template #east><NavButton to="room3">→</NavButton></template>
        <template #south><NavButton to="room5">↓</NavButton></template>
        <template #center>II</template>
      </RoomNav>
    </template>
  </Scene>
</template>
